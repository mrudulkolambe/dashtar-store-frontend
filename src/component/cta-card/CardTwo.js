        ...
        <div className="flex justify-between items-center">
          <div className="lg:w-3/5">
            ...
            <h2 className="font-serif text-lg lg:text-2xl font-bold mb-1">
              Quick Delivery to{' '}
              <span className="new-text-600">Your Home</span>
            </h2>
            ...
            <Link href="#downloadApp">
              <a className="lg:w-1/4 text-xs font-serif font-medium inline-block mt-5 px-8 py-3 new-bg text-center text-white rounded-full hover:text-white hover:bg-emerald-600">
                Download App
              </a>
            </Link>
          </div>
