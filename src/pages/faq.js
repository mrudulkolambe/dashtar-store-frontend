          ...
          <div className="grid gap-4 lg:mb-8 items-center md:grid-cols-2 xl:grid-cols-2">
            ...
            <div className="">
              <Disclosure>
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between w-full px-4 py-3 text-base font-medium text-left text-gray-600 focus:new-text-600 bg-gray-50 hover:bg-emerald-50 rounded-lg focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                      <span>How does the fruitflix work?</span>
                      <ChevronUpIcon
                        className={`${
                          open ? 'transform rotate-180 new-text-600' : ''
              ...
              <Disclosure as="div" className="mt-2">
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between w-full px-4 py-3 text-base font-medium text-left text-gray-600 focus:new-text-600 bg-gray-50 hover:bg-emerald-50 rounded-lg focus:outline-none">
              ...
              <Disclosure as="div" className="mt-2">
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between w-full px-4 py-3 text-base font-medium text-left text-gray-600 focus:new-text-600 bg-gray-50 hover:bg-emerald-50 rounded-lg focus:outline-none">
                      <span>What is fruitflix EC2 auto scaling?</span>
                      <ChevronUpIcon
                        className={`${
                          open ? 'transform rotate-180 new-text-600' : ''
                        } w-5 h-5 text-gray-500`}
              ...
              <Disclosure as="div" className="mt-2">
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between w-full px-4 py-3 text-base font-medium text-left text-gray-600 focus:new-text-600 bg-gray-50 hover:bg-emerald-50 rounded-lg focus:outline-none">
                      <span>
                        What are the benefits of using fruitflix affliate?
                      </span>
                      <ChevronUpIcon
                        className={`${
                          open ? 'transform rotate-180 new-text-600' : ''
