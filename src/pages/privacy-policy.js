        ...
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-4 sm:px-10">
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                At fruitflix, accessible from fruitflix dot com, one of our
                ...
                and recorded by fruitflix and how we use it. If you have
              ...
              <p>
                ...
                information that they shared and/or collect in fruitflix.we may
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                fruitflix follows a standard procedure of using log files.
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                the advertising partners of fruitflix. Third-party ad servers
                ...
                links that appear on fruitflix, which are sent directly to
                ...
                that you visit. Note that fruitflix has no access to or control
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                respective advertisements and links that appear on fruitflix,
                which are sent directly to users' browser. They automatically
                receive your IP address when this occurs. These technologies are
                used to measure the effectiveness of their advertising campaigns
                and/or to personalize the advertising content that you see on
                websites that you visit. Note that fruitflix has no access to
                or control over these cookies that are used by third-party
                advertisers.
              </p>
              <p>
                fruitflix's Privacy Policy does not apply to other advertisers
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              ...
              <p>
                fruitflix does not knowingly collect any Personal Identifiable
