        ...
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-3 sm:px-10">
          <div className="mb-8 lg:mb-12 last:mb-0">
            <h2 className="text-xl xl:text-2xl xl:leading-7 font-semibold font-serif mb-2 lg:mb-4">
              Welcome to fruitflix!
            </h2>
            <div className="font-sans leading-7">
              <p>
                These terms and conditions outline the rules and regulations for
                the use of fruitflix's Website, located at
                https://fruitflix.com/. By accessing this website we assume you
                accept these terms and conditions. Do not continue to use
                fruitflix if you do not agree to take all of the terms and
          ...
          <div className="mb-6 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                We employ the use of cookies. By accessing fruitflix, you
                agreed to use cookies in agreement with the fruitflix's Privacy
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                Unless otherwise stated, fruitflix and/or its licensors own the
                intellectual property rights for all material on fruitflix. All
                intellectual property rights are reserved. You may access this
                from fruitflix for your own personal use subjected to
              ...
              <p>
                ...
                website. fruitflix does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of fruitflix,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, fruitflix shall not be liable for
